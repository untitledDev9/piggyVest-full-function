      ...
      <Header
        ...
        <div className=' rounded-3xl px-10 flex items-center relative max-w-[1240px] bg-[#1843D0] h-[550px] mx-auto'>
            <div className=' flex flex-col gap-16'>
              <h1 className=' text-6xl w-[60%] font-semibold text-white'>The Better Way to Save and Invest</h1>
              <div className=' flex items-center gap-7'>
              <button className=' text-2xl bg-[#3333332b] py-4 px-5 rounded-4xl text-white flex items-center'><IoLogoApple size={30}/> Get on iPhone</button>
              <button className=' text-2xl bg-[#3333332b] py-4 px-5 rounded-4xl text-white flex items-center'><FaGooglePlay /> Get on Andriod</button>
            </div>
            </div>
